...
<head>
    ...
    <title>Terjadi Kesalahan Server - Smash Arena</title>
...
<body>
    <div class="container">
        ...
        <h1 class="error-code orange">500</h1>
        <h2 class="error-title">Terjadi Kesalahan Server</h2>
        <p class="error-desc">Tim teknis gelanggang sedang memperbaiki masalah ini. Silakan coba lagi dalam beberapa saat.</p>
        <a href="/" class="btn">
            <span class="btn-inner">Kembali</span>
        </a>
        <p class="footer-note">Jika masalah berlanjut, hubungi <a href="mailto:admin@smasharena.com">admin@smasharena.com</a></p>
    </div>
</body>
</html>
