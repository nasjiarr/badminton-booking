...
<head>
    ...
    <title>Halaman Tidak Ditemukan - Smash Arena</title>
...
<body>
    <div class="container">
        ...
        <h1 class="error-code volt">404</h1>
        <h2 class="error-title">Halaman Tidak Ditemukan</h2>
        <p class="error-desc">Lapangan yang Anda cari mungkin sudah dipindahkan atau tidak tersedia. Kembali ke gelanggang utama!</p>
        <a href="/" class="btn">
