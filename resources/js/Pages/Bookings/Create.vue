            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div v-if="loadingSlots" class="py-4">
                        <LoadingSkeleton variant="slot-grid" :count="16" />
                    </div>

                    <!-- Slots Grid -->
                    <div v-else-if="slots.length > 0" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-2.5 sm:gap-3">
                        <button
                            v-for="slot in slots"
                            :key="slot.start_time"
                            type="button"
                    ...
                    <div v-else class="py-4">
                        <EmptyState
                            icon="🕒"
                            title="Tidak Ada Slot Operasional"
                            description="Gelanggang tidak memiliki jadwal operasional pada tanggal ini. Silakan pilih tanggal lain."
                        />
                    </div>
